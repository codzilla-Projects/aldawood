...
?>
  <div class="container">
    ...
    <div class="row justify-content-center">
        <?php
        while($nuts->have_posts()) : $nuts->the_post(); 
        $post_id = get_the_ID();
        $likes = get_post_meta( $nuts->post_ID, "dawood_product_type", true); 
    ?>
